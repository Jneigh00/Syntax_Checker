...
"call"                              { parser.yylval = new ParserVal((String)yytext()); return Parser.CALL       ; }
...
"sizeof"                            { parser.yylval = new ParserVal((String)yytext()); return Parser.SIZEOF     ; }
"elemof"                            { parser.yylval = new ParserVal((String)yytext()); return Parser.ELEMOF     ; }
...
"-"                                 { parser.yylval = new ParserVal((String)yytext()); return Parser.EXPROP     ; }
"or"                                { parser.yylval = new ParserVal((String)yytext()); return Parser.EXPROP     ; }
"*"                                 { parser.yylval = new ParserVal((String)yytext()); return Parser.TERMOP     ; }
"/"                                 { parser.yylval = new ParserVal((String)yytext()); return Parser.TERMOP     ; }
"and"                               { parser.yylval = new ParserVal((String)yytext()); return Parser.TERMOP     ; }
...
"true"                              { parser.yylval = new ParserVal((String)yytext()); return Parser.BOOL_LIT   ; }
"false"                             { parser.yylval = new ParserVal((String)yytext()); return Parser.BOOL_LIT   ; }
"@"                                 { parser.yylval = new ParserVal((String)yytext()); return Parser.PTR        ; }
{int}                               { parser.yylval = new ParserVal((String)yytext()); return Parser.INT_LIT    ; }
{identifier}                        { parser.yylval = new ParserVal((String)yytext()); return Parser.IDENT      ; }
